...
export const STANDARD_SOCIAL_CONTRIBUTIONS: PayrollSocialContribution[] = [
  ...
  },
  {
    ...
    code: 'INPP_FORMATION',
    employeeRate: 0.0,
    employerRate: 3.0, // 3% employeur (entreprises de taille moyenne en RDC)
    ceilingAmount: undefined,
    isActive: true,
    description: 'Contribution patronale à la formation professionnelle continue.'
  },
  {
    id: 'sc-4',
 ...
 * Converti ou appliqué selon le revenu imposable net
 */
export const STANDARD_TAX_BRACKETS: PayrollTaxBracket[] = [
  ...
  { id: 'tb-5', min: 3000, max: null, rate: 40 } // Au-delà de 3 000 $ -> 40% (Plafonné à 30% global selon dispositions)
];
...
export function calculatePayslipSimulation(
  ...
  // Assiette cotisations sociales (base + primes soumises aux cotisations)
